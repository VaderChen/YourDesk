...
import (
	...
	"yourdeskandroid/core/internal/peertransport"
	"yourdeskandroid/core/internal/rawkey"
...
// TrafficBytes 回傳此連線各 DataChannel 的累計應用層資料量。
// 不包含網路封包標頭、重傳與尚在佇列中的資料。
