'use strict';
const strings={
 'zh-Hant':{brand:'YourDesk',address:'貼上遠端 ID 或 IP',connect:'連線 ↗',add:'＋ 新增站台',all:'所有站台',search:'搜尋名稱、裝置 ID 或備註',empty:'沒有符合的站台',preview:'',count:'{n} 個站台',close:'關閉',pending:'遠端連線尚未接入，目前為介面預覽。',manage:'站台管理尚未接入。',delete:'刪除',edit:'編輯',terminal:'終端機',desktop:'遠端桌面',online:'上線',offline:'離線'},
 en:{brand:'YourDesk',address:'Remote ID or IP',connect:'Connect ↗',add:'+ Add site',all:'All sites',search:'Search name, device ID or notes',empty:'No matching sites',preview:'',count:'{n} sites',close:'Close',pending:'Remote connections are not connected yet. This is a UI preview.',manage:'Site management is not connected yet.',delete:'Delete',edit:'Edit',terminal:'Terminal',desktop:'Remote desktop',online:'Online',offline:'Offline'},
 ja:{brand:'YourDesk',address:'リモート ID または IP',connect:'接続 ↗',add:'＋ サイト追加',all:'すべてのサイト',search:'名前、ID、メモを検索',empty:'該当するサイトなし',preview:'',count:'{n} サイト',close:'閉じる',pending:'リモート接続は未実装です。画面プレビューです。',manage:'サイト管理は未実装です。サンプルデータです。',delete:'削除',edit:'編集',terminal:'ターミナル',desktop:'リモートデスクトップ',online:'オンライン',offline:'オフライン'},
