...
本專案採[原始碼公開・禁止商業販售授權](LICENSE.md)：允許非販售的使用、修改及免費分享，包含公司內部自用；禁止販售、付費代管／SaaS、收費服務及付費產品整合，若有販售或整合需求，可另行討論授權；取得另行書面授權前仍依本授權辦理。第三方元件依各自授權處理。此為自訂授權，不屬於 OSI 定義的開源授權。
