...
Section "YourDesk"
 ...
 File /oname=YourDesk.installed "${MARKER_FILE}"
 File "${PAYLOAD_DIR}/release_zh-Hant.note"
 File "${PAYLOAD_DIR}/release_en.note"
 File "${PAYLOAD_DIR}/release_ja.note"
 File "${PAYLOAD_DIR}/release_ko.note"
...
Section "Uninstall"
 ...
 Delete "$INSTDIR\YourDesk.installed"
 Delete "$INSTDIR\release_zh-Hant.note"
 Delete "$INSTDIR\release_en.note"
 Delete "$INSTDIR\release_ja.note"
 Delete "$INSTDIR\release_ko.note"
