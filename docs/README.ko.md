...
들어오는 연결을 종료하는 트레이 항목과 빨간 버튼을 추가했으며 MCP 허용 목록 내 IP는 Token 없이 연결할 수 있습니다. macOS 로그인 전 연결은 기본으로 꺼진 실험 기능이며 실기기 미검증 상태입니다. 제한 사항과 변경 내용은 [릴리스 노트](RELEASE-1.26.0911-build-1012.md)를 확인하세요.
