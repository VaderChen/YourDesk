...
이 프로젝트는 자체 [소스 공개·상업적 판매 금지 라이선스](../LICENSE.ko.md)를 적용합니다. 기업 내부 사용을 포함한 비판매 사용, 수정 및 무료 공유를 허용합니다. 판매, 유료 호스팅/SaaS, 유료 서비스 및 유료 제품 통합은 금지하며 판매 또는 통합을 위한 별도 라이선스를 논의할 수 있으나 별도 서면 합의 전까지는 이 라이선스가 적용됩니다. 타사 구성 요소에는 각자의 라이선스가 적용됩니다. OSI 정의의 오픈 소스 라이선스가 아니며 번체 중국어 LICENSE 전문이 기준입니다.
