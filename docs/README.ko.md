...
**1.26.0915 build 1524는 로컬 Mac에서 원격 파일을 붙여넣지 못하는 문제를 수정합니다.** Finder에 파일을 등록하기 전에 네트워크 볼륨 접근을 확인하며, 사용자가 실제 기기에서 복구를 확인했습니다. 이 수정은 수신 Mac만 업데이트하면 됩니다. 권한 요청이 나타나면 허용한 후 다시 복사하세요. [릴리스 노트](RELEASE-1.26.0915-build-1524.md)를 참고하세요.
