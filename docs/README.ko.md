...
**1.26.0914 build 1419**는 영역 스트리밍, 보조 키와 마우스 수정, 데스크톱 QR 코드 및 간결한 표시 영역 도구 모음을 제공합니다. Windows 자르기는 사용자가 확인했으며 다른 기기 간 동작은 계속 검증 중입니다. [릴리스 노트](RELEASE-1.26.0914-build-1419.md)를 참고하세요.
